#include "../headers/ellipticnismodel.h"

EllipticNISModel::EllipticNISModel(){
    this->setName("Elliptic NIS");
...
double EllipticNISModel::jacobian(double x, double y){
    return x + y;
}

void EllipticNISModel::setAlphas(double x1, double x2){
    alpha1 = x1 + x2;
}

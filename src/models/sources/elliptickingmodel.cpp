#include "../headers/elliptickingmodel.h"

EllipticKingModel::EllipticKingModel(){
    this->setName("Elliptic King");
...
double EllipticKingModel::jacobian(double x, double y){
    return x + y;
}

void EllipticKingModel::setAlphas(double x1, double x2){
    alpha1 = x1 + x2;
}

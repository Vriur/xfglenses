#include "../headers/ellipticmodel.h"

EllipticModel::EllipticModel(){
    this->setName("Elliptic Model");
    ...
    this->parameters.push_back(new ModelParameter("Alpha", 0.20, 0.00, 1.00));
}

double EllipticModel::jacobian(double x, double y){
    return x + y;
}

void EllipticModel::setAlphas(double x1, double x2){
    alpha1 = x1 + x2;
}
